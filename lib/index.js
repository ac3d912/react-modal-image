...
var _default = function (_Component) {
  ...
  _default.prototype.render = function render() {
    var _props = this.props,
        ...
        renderRoot = _props.renderRoot;
    var modalOpen = this.state.modalOpen;

    var wrapit = function wrapit(element) {
      return renderRoot ? _reactDom2.default.createPortal(element, document.getElementById("root")) : element;
    };
    ...
    return _react2.default.createElement(
      ...
      modalOpen && wrapit(_react2.default.createElement(_Lightbox2.default, {
        medium: medium,
        large: large,
        alt: alt,
